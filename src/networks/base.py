...
class BaseModel():
    ...
    def __init__(self, config, network_type):
        ...
        self.dir_log = "./logs/"+network_type+"/"+config.env_name+"/"
        self.train_steps = 0
    ...
    def save_session(self,step):
        ...
        self.saver.save(self.sess, self.dir_model,global_step=step)


    def restore_session(self):
        model_path = tf.train.latest_checkpoint(self.dir_model)
