...
class ApplicationWindow(QMainWindow):
    def __init__(self):
        ...
        self.env = Market('OIH', '/Users/wweschen/rl-trader/data/oil.txt', 4, 1000)

        self.env.enable_chart( True, parent=self,app=app)
        ...
        #             play(chart, env)
        self.env.chart.position_data = PositionHistoryData(170)
        self.env.chart.rewards_data = RewardHistoryData(170)

        l.addWidget(self.env.chart)
        ...
        timer=QtCore.QTimer.timeout().Connect( self.env.play)
